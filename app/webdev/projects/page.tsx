...
export default function WebDevProjects() {
  ...
  const projects: Project[] = [
    ...
    },
    {
      id: 2,
      title: "Waycode",
      description: "Modern AI company landing page ",
      image: "/waycode.png?height=200&width=300",
      website: "https://waycode.vercel.app/",
      github: "",
      techStack: ["React Vite", "Framer Motion", "Styled Components", "Tailwindcss"],
      category: "frontend",
    },
    {
      id: 3,
      title: "Well-Web Astra",
      description: "SaaS Landing Page",
      image: "/astra.png?height=200&width=300",
      website: "https://well-web-flax.vercel.app/",
      github: "",
      techStack: ["Nextjs","Reactjs","Tailwindcss","Clerk","ShadcnUI"],
      category: "frontend",
    },
    {
      id: 4,
